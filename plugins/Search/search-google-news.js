  ...
  try {
    ...
    if (newsData && newsData.total > 0) {
      ...
      await conn.reply(m.chat, caption, m, {
        contextInfo: {
          externalAdReply: {
            body: `Berita terbaru untuk ${text}`,
            mediaType: 1,
            mediaUrl: newsData.news[0]?.img[0] || "https://upload.wikimedia.org/wikipedia/commons/d/d1/Image_not_available.png",
            previewType: 0,
            renderLargerThumbnail: true,
            sourceUrl: `https://news.google.com/search?q=${encodeURIComponent(text)}`,
            thumbnailUrl: newsData.news[0]?.img[0] || "https://upload.wikimedia.org/wikipedia/commons/d/d1/Image_not_available.png",
